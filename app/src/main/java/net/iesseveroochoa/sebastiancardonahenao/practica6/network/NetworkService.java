package net.iesseveroochoa.sebastiancardonahenao.practica6.network;
...
import net.iesseveroochoa.sebastiancardonahenao.practica6.model.ListaPokemon;
...
public class NetworkService {
    private static final String TAG = "Network Service LOG: ";
    ...
    public void getSiguientesPokemonsApi(){
        ...
        if(pokemonRespuestaApi ==null)//es la primera llamada con la url basica
            ...
            https://pokeapi.co/api/v2/pokemon?offset=120&limit=20
                    ...
                    listaPokemonApiCall=servicioWebPokemon.getListaPokemon(pokemonRespuestaApi
                            .getUriSiguientes());
        //hacemos la llamada
